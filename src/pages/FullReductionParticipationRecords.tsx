...
import { formatRuleSummary } from '../utils/fullReductionActivity'

interface FullReductionParticipationRecordsProps {
  activity: FullReductionActivityForm
  onBack: () => void
  onExport?: () => void
}

export function FullReductionParticipationRecords({ activity, onBack, onExport }: FullReductionParticipationRecordsProps) {
  return (
