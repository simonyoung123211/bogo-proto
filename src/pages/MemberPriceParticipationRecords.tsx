...
import { formatRuleSummary } from '../utils/memberPriceActivity'

interface MemberPriceParticipationRecordsProps {
  activity: MemberPriceActivityForm
  onBack: () => void
  onExport?: () => void
}

export function MemberPriceParticipationRecords({ activity, onBack, onExport }: MemberPriceParticipationRecordsProps) {
  return (
